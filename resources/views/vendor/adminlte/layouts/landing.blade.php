...
<div id="app" v-cloak>
    ...
    <div id="navigation" class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#"><b>Smart Orchid</b></a>
            </div>
            <div class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    <li class="active"><a href="#home" class="smoothScroll">Home</a></li>
                    <li><a href="#desc" class="smoothScroll">ioT</a></li>
                    <li><a href="#showcase" class="smoothScroll">Description</a></li>
            ...
            <div class="container">
                <div class="row centered">
                    <div class="col-lg-12">
                        ...
                        <h3>Let's Start Orchid Cultivation With Internet Of Things</h3>
                        <h3><a href="{{ url('/login') }}" class="btn btn-lg btn-success">{{ trans('adminlte_lang::message.gedstarted') }}</a></h3>
                    </div>
                    <div class="col-lg-2">
                        <h5>Mari Bercocok Tanam</h5>
                        <p>Dengan Teknologi</p>
                        <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/img/arrow1.png') }}">
                    </div>
                    <div class="col-lg-8">
                        <img class="img-responsive" src="{{ asset('/img/orchid.jpg  ') }}" alt="">
                    </div>
                    <div class="col-lg-2">
                        <br>
                        <img class="hidden-xs hidden-sm hidden-md" src="{{ asset('/img/arrow2.png') }}">
                        <h5>Hijaukan Indonesia</h5>
                        <p>Dengan Teknologi</p>
                    </div>
                </div>
            </div> <!--/ .container -->
    ...
    <section id="desc" name="desc">
        ...
        <div id="intro">
            <div class="container">
                <div class="row centered">
                    <h1>Internet Of Things Orchid Cultivation</h1>
                    <br>
                    <br>
                    <div class="col-lg-4">
                    ...
                    <div class="col-lg-4">
                        ...
                        <p>Schedule Orchid Cultivation</p>
                    </div>
                    <div class="col-lg-4">
        ...
        <div id="features">
            <div class="container">
                <div class="row">
                    <h1 class="centered">Orchid Flowers is...</h1>
                    <br>
                    <br>
